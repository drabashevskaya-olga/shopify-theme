(function() {
  ...
  var idme = `<div class="idme">
    <div class="idme-shopify">
      <p class='idme-btn-affinity'>Alumni, Government Employees, Military, Nurses, First Responders, Students, and Teachers receive 20% off</p>
...
function idmePopUp() {
  ...
  window.open("https://discountify.id.me/oauth/checkpoint/reathlete", "", "scrollbars=yes,menubar=no,status=no,location=no,toolbar=no,width=800,height=780,top=" + top + ",left=" + left);
};
...
if (urlParams.get('popup')) {
  if (window.opener) {
    window.opener.location.reload();
  	...
  	window.location.href = "https://reathlete.myshopify.com/checkout";
  }
};
